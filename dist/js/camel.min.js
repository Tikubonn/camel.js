...
v("Promise",function(c){function b(a){this.b=0;this.i=void 0;this.a=[];var d=this.g();try{a(d.resolve,d.reject)}catch(l){d.reject(l)}}function f(){this.a=null}function e(a){return a instanceof b?a:new b(function(d){d(a)})}if(c)return c;f.prototype.b=function(a){null==this.a&&(this.a=[],this.h());this.a.push(a)};f.prototype.h=function(){var a=this;this.g(function(){a.m()})};var g=n.setTimeout;f.prototype.g=function(a){g(a,0)};f.prototype.m=function(){for(;this.a&&this.a.length;){var a=this.a;this.a=
...
break a;default:d=!1}d?this.v(a):this.m(a)}};b.prototype.v=function(a){var d=void 0;try{d=a.then}catch(l){this.h(l);return}"function"==typeof d?this.B(d,a):this.m(a)};b.prototype.h=function(a){this.s(2,a)};b.prototype.m=function(a){this.s(1,a)};b.prototype.s=function(a,d){if(0!=this.b)throw Error("Cannot settle("+a+", "+d+"): Promise already settled in state"+this.b);this.b=a;this.i=d;this.u()};b.prototype.u=function(){if(null!=this.a){for(var a=0;a<this.a.length;++a)h.b(this.a[a]);this.a=null}};
var h=new f;b.prototype.A=function(a){var d=this.g();a.l(d.resolve,d.reject)};b.prototype.B=function(a,d){var b=this.g();try{a.call(d,b.resolve,b.reject)}catch(k){b.reject(k)}};b.prototype.then=function(a,d){function c(a,d){return"function"==typeof a?function(d){try{k(a(d))}catch(x){e(x)}}:d}var k,e,f=new b(function(a,d){k=a;e=d});this.l(c(a,k),c(d,e));return f};b.prototype.catch=function(a){return this.then(void 0,a)};b.prototype.l=function(a,d){function b(){switch(c.b){case 1:a(c.i);break;case 2:d(c.i);
break;default:throw Error("Unexpected state: "+c.b);}}var c=this;null==this.a?h.b(b):this.a.push(b)};b.resolve=e;b.reject=function(a){return new b(function(d,b){b(a)})};b.race=function(a){return new b(function(d,b){for(var c=w(a),l=c.next();!l.done;l=c.next())e(l.value).l(d,b)})};b.all=function(a){var d=w(a),c=d.next();return c.done?e([]):new b(function(a,b){function l(d){return function(b){f[d]=b;k--;0==k&&a(f)}}var f=[],k=0;do f.push(void 0),k++,e(c.value).l(l(f.length-1),b),c=d.next();while(!c.done)})};
...
throw Error("");};b.prototype.j=function(a){return 0<=a.indexOf(this)};window.CamelRequest=b;f.prototype=Object.create(c.prototype);f.prototype.name=function(){return this.a};f.prototype.download=function(){var a=this.b.find(this.a);if(a)return a.download();throw Error(""+this.a+" is undefined in Camel instance.");};f.prototype.get=function(){var a=this.b.find(this.a);if(a)return a.get();throw Error(""+this.a+" is undefined in Camel instance.");};f.prototype.j=function(a){var d=this.b.find(this.a);
if(d)return d.j(a);throw Error(""+this.a+" is undefined in Camel instance.");};e.prototype=Object.create(c.prototype);e.prototype.name=function(){return this.a.name()};e.prototype.download=function(){return Promise.all(this.b.map(function(a){return a.download()})).then(this.a.download.bind(this.a))};e.prototype.get=function(){return this.a.get()};e.prototype.j=function(a){if(this.a.j(a))return!0;var d;for(d=0;d<this.b.length;d++){var b=this.b[d],c=a.slice();c.push(this.a);if(b.j(c))return!0}return!1};
